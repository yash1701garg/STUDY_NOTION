...
<body>
    <div class="container">
        ...
        <div class="body">
            <p>Hey ${name},</p>
            <p>Your have successfully registered for the course <span class="highlight">${courseName}</span>. We are excited to have you as a participant!</p>
            <p>Please log in to your learning dashboard to access the course materials and start your learning journey with us.</p>
